...
import { ShoppingCart, Crown, X, Settings } from 'lucide-react'
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {membershipPlans.map((plan) => (
                  <div key={plan.key} className="bg-[#0A0C0E] p-6 rounded-lg">
                    <h4 className="text-[#00F5D4] font-bold mb-2">
                      {t(`membership.plans.${plan.key}.name`)}
                    </h4>
                    <div className="text-2xl font-bold text-white mb-2">
                      {t(`membership.plans.${plan.key}.price`)}
                    </div>
                    <p className="text-white/60 text-sm mb-4">
                      {t(`membership.plans.${plan.key}.description`)}
                    </p>
